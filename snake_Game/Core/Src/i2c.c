...
/**
  ...
  * @param OutputDev2ice: can be OUTPUT_DEVICE_SPEAKER, OUTPUT_DEVICE_HEADPHONE,
...
/**
  ...
  * @note This function modifies a global variable of the audio codec driver: OutputDev2.
  * @param DeviceAddr: Device address on communication Bus.
